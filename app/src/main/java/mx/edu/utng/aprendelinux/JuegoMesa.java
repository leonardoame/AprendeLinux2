 ...
 *
 */
public class JuegoMesa implements OnClickListener{
	...
	private int tileSize; // longitud del lado de la baldosa en px, e. gramo. 160
	...
	public JuegoMesa(Dimension gameSize, RelativeLayout scr, int orientation, Context con){
		this.gameSize = gameSize;
		this.screen = scr;
		this.context = con;
		this.orientation = orientation;
		
		//Si orientatnion es horizontal , tenemos que voltear gameSize .
	...
	public void calculateTileSize(){
		...
		//Y tener la resolución, que ahora podemos calcular el tamaño de la baldosa .
		int tSize = (int) (screenResolution.x/gameSize.x);
		if(tSize*gameSize.y>screenResolution.y){

// Eso significa que la altura de la pantalla es demasiado pequeña como para caber todas las fichas .
// En este caso el tamaño del azulejo necesita ser recalculado , teniendo
// Altura que el tamaño importante , en lugar de ancho
