...
//    	  Log.d("KAMIL", "Orientation recorded by puzzleactivity: " + str);
        ...
        //el bloqueo de la aplicación en la posición necesaria
        if(screenOrientation == JuegoMesa.ORIENTATION_PORTRAIT)
        ...
        //Crando el juego de mesa
        board = new JuegoMesa(decodeGameSizeFromIntent(),
